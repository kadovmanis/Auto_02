...
//#define		USB_BUS_SENSE	 USB_5V
//#define		USE_USB_BUS_SENSE_IO
//------------------------------------------------------------------------------

// Parameter definitions are defined in usb_device.h
#define		USB_PULLUP_OPTION		USB_PULLUP_ENABLE			// USB_PULLUP_ENABLE		/ USB_PULLUP_DISABLED
#define 	USB_SPEED_OPTION		USB_FULL_SPEED				// USB_FULL_SPEED			/ USB_LOW_SPEED (this mode is only supported on some microcontrollers)
#define 	USB_TRANSCEIVER_OPTION	USB_INTERNAL_TRANSCEIVER	// USB_INTERNAL_TRANSCEIVER	/ USB_EXTERNAL_TRANSCEIVER
			// External Transceiver support is not available on all product families.
			// Please refer to the product family datasheet for more information if this feature is available on the target processor.

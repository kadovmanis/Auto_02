...
// String Descriptors
const struct						//Language code string descriptor
{
	uint8_t		bLength;
	uint8_t		bDscType;
	uint16_t	string[1];
...
const struct						//Manufacturer string descriptor
{
	uint8_t		bLength;
	uint8_t		bDscType;
	uint16_t	string[USB_DESCRIPTOR_MANUFACTURER_SIZE];
} sd001 =
{
	sizeof(sd001),
	USB_DESCRIPTOR_STRING,
...
const struct						//Product string descriptor
{
	uint8_t		bLength;
	uint8_t		bDscType;
	uint16_t	string[USB_DESCRIPTOR_PRODUCT_SIZE];
} sd002 =
{
	sizeof(sd002),
	USB_DESCRIPTOR_STRING,
